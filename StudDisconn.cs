...
{
    public partial class StudDisconn : Form
    {
        SqlConnection con;
        SqlDataAdapter da;
        ...
        {
            da = new SqlDataAdapter("select * from student5", con);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                DataSet ds = GetAllProducts();
                DataRow row = ds.Tables["stud"].Rows.Find(textId.Text);
                if (row != null)
                {
                    row["fname"] = textfName.Text;
                    row["lname"] = textlName.Text;
